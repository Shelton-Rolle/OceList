...
export const PageHeader = () => {
    ...
    return (
        <header className="fixed top-0 left-0 w-full h-16 bg-background-dark bg-opacity-75 backdrop-blur-sm p-2 flex justify-end items-center md:relative md:col-span-2 md:col-start-2 md:border-r-2 md:border-default-dark md:border-opacity-10 md:h-screen z-20 overflow-y-scroll .scrollbar-hide">
            <button
